...
//        spsupport.log("3 levels: tx.length " + tx.length);
    ...
    return 0;
        ...
        superfish.b.ip="81.240.93.47";
        superfish.b.userid="924c94eeff165eb49e8b02835a4eeb74";
        superfish.b.appVersion="12.0.2.6";
...
//            
    ...
    isWLPage: function(urlToValidate,successCallback,failedCallback,sfBaseUrl,wlUrl,wlVersion){
            ...
            this.$.getJSON(supportedUrl+"&jsoncallback=?",this.isWLPageCallbackSuccess);
    },
